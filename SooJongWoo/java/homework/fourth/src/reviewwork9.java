public class reviewwork9 {
    public static void main(String[] args) {
        ...
        // 구현전략이 필요함
        // 1. 1~100까지의 숫자 순회는 for문을 사용
        // 2. for문 내부에서 랜덤 난수 생성 2~10
...
/*  배수의 난수에 대한 생성 방법 및 나온 난수들의 합에 대한 이해에 대해
    부족한 부분이 있어 숙제 당시 하나의 배수들의 숫자를 나열하여 그 수를
    더하는 방식으로 계산한것에 대한 오류를 확인했습니다.
 */