...
public class Sixth36thProductBoardController {
    ...
    @GetMapping("/register")
    public String registerForm (Product productBoard) {
    ...
    public String register (Product productBoard, Model model) {
    ...
    @PostMapping("/modify")
    public String modify (Product productBoard, Model model) {
        log.info("modify");
