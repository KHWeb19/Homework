...
public class Meal {
    static final int MEAL_TIME_COUNT = 3; // 식사는 하루에 총 3번
    ...
    //          그렇기 때문에 이런 코드가 난무하는 회사에서는 지옥같은 일상이 펼쳐지게 됨.
    ...
    public void initMeal (){
        meal = new Date[MEAL_TIME_COUNT]; // 식사 시간이 3개다.
        menu = new Menu();

        menu.initMenu();
        //menu = new String[MEAL_TIME_COUNT][SIDE_DISH_MAX];
    }
...
// 학교의 식사 일정
// 1. 조식, 중식, 석식
// 2. 식단표(요약) : 조식(7시 10 ~ 8시), 중식(12~13), 석식(17~ 18)
//                 메뉴 (밥, 국, 반찬[2 ~4]
