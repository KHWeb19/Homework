public class RandomGenerator {
    ...
    public RandomGenerator(int intMin, int intMax) {
        this.intMin = intMin;
        this.intMax = intMax;
    ...
    public RandomGenerator(int intMin, int intMax, int intMin2, int intMax2) {
        this.intMin = intMin;
        this.intMax = intMax;
    ...
    public RandomGenerator(int intMin, int intMax, int condMin, int condMax, int condMin2, int condMax2) {
        this.intMin = intMin;
        this.intMax = intMax;
        intRange = intMax - intMin + 1;
    ...
    public boolean confrimComplicatedRandom (){
        int tmp, tmp2;
        for (int i = 0; i < CHECK_NUM; i++) {
            tmp = intGenerate();
