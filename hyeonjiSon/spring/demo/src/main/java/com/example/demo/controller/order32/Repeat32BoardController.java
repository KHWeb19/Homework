...
@Slf4j
@Controller
@RequestMapping("/repeat32/board")
public class Repeat32BoardController {
    @Autowired
    ...
    public String registerForm (Board board) {
        ...
        // HTML 페이지 띄움
        return "/repeat32/board/register";
    }
