...
public class Menu {
    ...
    private void systemInit() {
        while (initNotFinish) {
            //addMenu 매서드를 호출함(역시 객체 내부에 들어있기 때문에 가능) / 아니었다면 init. 사용해서 호출해야 했을 것.
            addMenu();
            ...
            //문자열 간 같은지 여부 판정은 equals()를 통해 비교한다.
            //yorN.equals("n")은 yorN 라는 녀석이 "n"과 동일한 녀석인지 판정한다.
            if (yOrN.equals("n")) {
                initNotFinish = false;
            }
        }
