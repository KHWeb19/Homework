...
export default {
    ...
    methods: {
        onClickTd () {
            ...
            this.$set(this.tableData[this.rowIndex], this.cellIndex, this.turn) //tabledata배열 rowIndex행의 cellIndex열의 값이 this.turn으로 세팅됌
            ...
            if (win) {
                ...
                this.tableData.forEach(row => { //
                    row.forEach(cell => {  //cell에 값이 없으면 false 근데 cell에 다 값이 있으면 true로 내려감
                        if (!cell) {   
                            all = false
                        } 
                    }) 
